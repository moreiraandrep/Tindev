...
export default function Main({ match }) {
   ...
   }, [match.params.id]); //[match.params.id] todo vez que um novo user logar, exetuta useEffect
   ...
   return (
      <div className="main-container">
         ...
         { users.length > 0 ? (
            ...
            <div className="empty">Não encontramos mais pessoas. Tente novamente depois :(</div>
         )}
